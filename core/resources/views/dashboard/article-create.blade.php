                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input name="title" value="" class="form-control input-lg" type="text" required placeholder="Article Title">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea name="description" id="" cols="30" rows="10"
                                          class="wysihtml5 form-control input-lg" required placeholder="Article Description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-7">
                                    <button type="submit" id="btn-submit" class="btn blue btn-block margin-top-10"><i class="fa fa-paper-plane"></i> Create New Article</button>
                                </div>
                            </div>
                        </div>
                    </div>
